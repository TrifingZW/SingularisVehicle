...
UBaseVehicleWheelFront::UBaseVehicleWheelFront()
{
	...
	WheelRadius = 39.0f; // 设置轮胎的半径为39厘米，影响轮胎的大小和地面接触面积。
	WheelWidth = 35.0f; // 设置轮胎的宽度为35厘米，影响轮胎的抓地力和稳定性。
	FrictionForceMultiplier = 3.0f; // 设置摩擦力倍增因子为3.0，调整轮胎与地面之间的摩擦力，值越大，轮胎的抓地力越强。

	MaxBrakeTorque = 4500.0f; // 设置最大刹车扭矩为4500，影响车辆刹车时施加的最大力量，值越大，刹车效果越强。
	MaxHandBrakeTorque = 6000.0f; // 设置最大手刹扭矩为6000，影响手刹的效果，值越大，手刹的强度越大，能更有效地让车轮停止转动。
}
